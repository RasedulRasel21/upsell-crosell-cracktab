...
INSERT INTO "new_UpsellBlock" ("active", "autoSlide", "backgroundColor", "borderRadius", "buttonColor", "buttonText", "centerPadding", "columns", "createdAt", "id", "layout", "name", "padding", "placement", "productHandles", "properties", "shop", "showCount", "slideDuration", "textColor", "title", "updatedAt") SELECT "active", "autoSlide", "backgroundColor", "borderRadius", "buttonColor", "buttonText", "centerPadding", "columns", "createdAt", "id", "layout", "name", "padding", "placement", "productHandles", "properties", "shop", "showCount", "slideDuration", "textColor", "title", "updatedAt" FROM "UpsellBlock";
