...
INSERT INTO "new_UpsellBlock" ("active", "autoSlide", "backgroundColor", "borderRadius", "buttonColor", "buttonText", "centerPadding", "createdAt", "id", "layout", "name", "padding", "placement", "productHandles", "shop", "showCount", "slideDuration", "textColor", "title", "updatedAt") SELECT "active", "autoSlide", "backgroundColor", "borderRadius", "buttonColor", "buttonText", "centerPadding", "createdAt", "id", "layout", "name", "padding", "placement", "productHandles", "shop", "showCount", "slideDuration", "textColor", "title", "updatedAt" FROM "UpsellBlock";
